...
import summerBg from '../assets/summer_bg.png';
...
const slides = [
    ...
    },
    {
        ...
        title: "Summer Vibes",
        subtitle: "Breezy Styles for You!",
        offer: {
            prefix: "UP TO",
            value: "40",
            suffix: "% OFF"
        ...
        code: "SUMMER40",
        images: [hero2, hero3, hero1] // Shuffled
    },
    {
        id: 3,
        bgImage: weddingBg,
        ...
        code: "WEDDING15",
        images: [hero3, hero1, hero2] // Shuffled
    },
    {
        id: 4,
        bgImage: partyBg,
        ...
        code: "PARTY10",
        images: [hero1, hero3, hero2] // Shuffled
    }
];
...
const Hero = () => {
    ...
    return (
        <section
            className="relative w-full overflow-hidden py-12 md:py-20 bg-cover bg-center bg-no-repeat transition-all duration-700 ease-in-out"
            style={{ backgroundImage: `url(${slide.bgImage})`, backgroundColor: slide.theme.bgColor }}
        >
            <div className="container mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center justify-center gap-12 transition-opacity duration-500 ease-in-out">
                ...
                <div className="flex justify-center items-end gap-4 md:gap-6 lg:w-1/2">
                    ...
                    <div className="w-28 md:w-40 lg:w-48 h-64 md:h-80 lg:h-96 rounded-t-[100px] overflow-hidden border-2 border-white/50 shadow-xl transform translate-y-4">
                        <img src={slide.images[0]} alt="Ethnic Wear" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" />
                    </div>
                    ...
                    <div className="w-32 md:w-48 lg:w-56 h-72 md:h-96 lg:h-[28rem] rounded-t-[120px] overflow-hidden border-2 border-white/80 shadow-2xl z-10 -mt-8">
                        <img src={slide.images[1]} alt="Wedding Collection" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" />
                    </div>

                    {/* Image 3 - Right Arch */}
                    <div className="w-28 md:w-40 lg:w-48 h-64 md:h-80 lg:h-96 rounded-t-[100px] overflow-hidden border-2 border-white/50 shadow-xl transform translate-y-4">
                        <img src={slide.images[2]} alt="Festive Look" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" />
                    </div>
                </div>
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                {slides.map((_, index) => (
                    <button
                        key={index}
                        className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === index ? 'bg-gray-800 w-6' : 'bg-gray-400'}`}
